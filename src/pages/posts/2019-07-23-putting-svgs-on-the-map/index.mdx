...
<img className={style.UKAndIreland} src={UKAndIreland} alt="UK and Ireland"/>
...
<img className={style.UKAndIreland} src={UKAndIrelandCircles} alt="UK and Ireland Circles"/>
